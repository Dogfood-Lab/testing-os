...
- [x] `[cli]` `--help` output accurate for all commands and flags — `swarm` bin documents its 21 subcommands (init, domains, dispatch, collect, revalidate, rewind, redrive, verify, verify-fixed, verify-recurring, verify-unverified, verify-approved, receipt, advance, status, resume, history, approve, persist, findings, runs) (2026-04-25, last re-affirmed 2026-06-02 at v1.3.2)
