...
<!-- version:start -->
**v1.2.2** — 7 पैकेज (`@dogfood-lab/*`), पूरे कार्यक्षेत्र के लिए परीक्षण सूट, 'इंजस्ट' रिसीवर लाइव, हैंडबुक तैनात।
<!-- version:end -->
...
**v1.2.2** — यह एक रनटाइम पैच रिलीज है, जिसमें `better-sqlite3` को `^11.0.0` से बढ़ाकर `^12.10.0` किया गया है (अब `@dogfood-lab/dogfood-swarm` में SQLite 3.53.1 शामिल है, पहले यह 3.50.x था)। परीक्षण-रनटाइम टूल भी अपडेट किए गए हैं: `vitest` + `@vitest/coverage-v8` को `3.2.4` से बढ़ाकर `4.1.6` किया गया है (यह केवल विकास के लिए है, इसका प्रकाशित पैकेजों पर कोई प्रभाव नहीं है)। सभी फेज 5 की विशेषताएं v1.2.0 से बरकरार हैं: वेव-लेवल स्टेट मशीन + थ्री आर रिकवरी कॉन्ट्रैक्ट (`swarm revalidate`, `swarm rewind`, `swarm redrive`) + `swarm history` ऑडिट-ट्रेल क्रिया + स्टेज ए–डी स्वास्थ्य जांच, जिसमें 0 क्रिटिकल और 0 हाई त्रुटियां हैं। छह पैकेज `@dogfood-lab` के अंतर्गत प्रकाशित किए गए हैं: `schemas`, `verify`, `report`, `ingest`, `findings`, `dogfood-swarm`. **1105/1105 परीक्षण पास हुए।** रिपॉजिटरी के पूरे जीवनकाल में (v1.0.0 के बाद से, 2026-04-25 तक): फेज 7 का डॉगफूड स्वार्म (लगभग 31 वेव, लगभग 115 सत्यापित-सुधार, 14 ऑडिट-कवरेज क्लास) और v1.2.x का पहला npm प्रकाशन। आधिकारिक स्वार्म कैटलॉग: [`docs/swarm-evidence-2026-04-27.md`](docs/swarm-evidence-2026-04-27.md)।
