...
**v1.2.1** — यह एक मामूली अपडेट है जिसमें "टेस्टिंग-ओएस" का लोगो प्रत्येक पैकेज के साथ जुड़े दस्तावेज़ (README) में जोड़ा गया है, ताकि यह हर npm पेज पर दिखाई दे। (v1.2.0 में, उसी दिन तीन पैकेज बिना लोगो के जारी किए गए थे — v1.2.1 में किए गए सुधारों से सभी 6 पैकेजों में यह समस्या ठीक हो गई है)। v1.2.0 के सभी "फेज़ 5" के फीचर्स बरकरार हैं: वेव-लेवल स्टेट मशीन + "थ्री आर" रिकवरी कॉन्ट्रैक्ट (`स्वार्म रीवैलिडेट`, `स्वार्म रीवाइंड`, `स्वार्म रीड्राइव`) + `स्वार्म हिस्ट्री` ऑडिट-ट्रेल वर्ब + स्टेज ए-डी स्वास्थ्य जांच, जिसमें 0 क्रिटिकल और 0 हाई प्राथमिकता वाली समस्याएं हों। छह पैकेज `@dogfood-lab` के अंतर्गत प्रकाशित किए गए हैं: `स्कीमा`, `वेरिफाई`, `रिपोर्ट`, `इंजस्ट`, `फाइंडिंग्स`, `डॉगफूड-स्वार्म। **1105/1105 परीक्षण पूरे हुए।** रिपॉजिटरी के पूरे जीवनकाल में (v1.0.0 के बाद से, 2026-04-25 तक): "फेज़ 7" का "डॉगफूड स्वार्म" (लगभग 31 वेव, लगभग 115 सत्यापित और लागू किए गए सुधार, 14 ऑडिट कवरेज श्रेणियां) और अब v1.2.x का पहला npm प्रकाशन। आधिकारिक स्वार्म कैटलॉग: [`docs/swarm-evidence-2026-04-27.md`](docs/swarm-evidence-2026-04-27.md)।
