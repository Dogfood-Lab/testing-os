...
<!-- संस्करण: प्रारंभ -->
**v1.3.0** — 7 पैकेज (`@dogfood-lab/*`), वर्कस्पेस-व्यापी परीक्षण सूट, इनजेस्ट रिसीवर लाइव, हैंडबुक तैनात।
<!-- संस्करण: अंत -->
...
**v1.3.0** — प्रत्येक उपभोक्ता में एकल विहित स्कीमा सत्यापनकर्ता (प्रति स्कीमा प्रति प्रक्रिया में एक Ajv उदाहरण; वर्कस्पेस-होइस्ट विभाजन एक सख्त बाधा है)। स्थिर कोड (`ISOLATION_FAILED`, `DUPLICATE_RUN_ID`, `STATE_MACHINE_*`, `DISPATCH_*`, `VALIDATOR_FAULT_*`, ...) के साथ संरचित शीर्ष-स्तरीय त्रुटियां और प्रत्येक विफलता पथ पर एक `अगला:` संकेत। नीति YAML अब लोड समय पर स्कीमा-गेटेड है — एक संरचनात्मक रूप से अमान्य नीति फ़ाइल चुपचाप डिफ़ॉल्ट मानों पर जाने के बजाय जोर से विफल हो जाती है। हैंडबुक [dogfood-lab.github.io/testing-os/](https://dogfood-lab.github.io/testing-os/) पर प्रकाश/अंधेरे थीम समानता, प्रति-पृष्ठ WCAG-AA पहुंच (सीआई में पुन: प्रयास के साथ pa11y), प्रति-क्रिया `स्वार्म` सीएलआई संदर्भ और एक कस्टम 404 के साथ शिप करता है। छह पैकेज v1.3.0 में एक साथ `@dogfood-lab` के तहत npm पर प्रकाशित होते हैं — नीचे तालिका देखें। v1.2.x से कोई ब्रेकिंग परिवर्तन नहीं। पूर्ण v1.3.0 प्रविष्टि के लिए [CHANGELOG.md](CHANGELOG.md) देखें।

रिसीवर लाइव है: उपभोक्ता रिपॉजिटरी में `dogfood.yml` वर्कफ़्लो इस रिपॉजिटरी पर भेजते हैं, और [.github/workflows/ingest.yml](.github/workflows/ingest.yml) परिणामी रिकॉर्ड और इंडेक्स को वापस `मुख्य` पर कमिट करता है। हैंडबुक [dogfood-lab.github.io/testing-os/](https://dogfood-lab.github.io/testing-os/) पर तैनात है। मुख्य स्थापना: `npm install -g @dogfood-lab/dogfood-swarm`। रिसीवर पक्ष प्रेषण के माध्यम से खपत करता रहता है — हैंडबुक के एकीकरण पृष्ठ देखें।

**प्लेटफ़ॉर्म:** सेशन जी ([`docs/m5-validation-2026-04-29.md`](docs/m5-validation-2026-04-29.md)) के हिस्से के रूप में डार्विन/एपीएफएस पर एंड-टू-एंड मान्य। समर्थित फ़ाइल सिस्टम के लिए [स्थानीय विकास](#स्थानीय-विकास) देखें। प्रति-संस्करण विवरण [CHANGELOG.md](CHANGELOG.md) में।
...
**आवश्यक अनुमतियाँ:** रिसीवर वर्कफ़्लो केवल इस रिपॉजिटरी के लिए `सामग्री: लिखें` के साथ चलता है। प्रोवेनैंस सत्यापन केवल पढ़ने के लिए एक्शन एपीआई कॉल के लिए वर्कफ़्लो के डिफ़ॉल्ट `GITHUB_TOKEN` का उपयोग करता है। **कोई टेलीमेट्री नहीं, कोई तृतीय-पक्ष सेवाएँ नहीं, कोई एनालिटिक्स नहीं — यह कोडबेस न तो घर फोन करता है और न ही गिटहब से परे कोई नेटवर्क सतह उजागर करता है।**
...
| `@dogfood-lab/findings` | JS | निष्कर्ष अनुबंध + प्राप्त/समीक्षा/संश्लेषण/सलाह पाइपलाइन। |
...
सभी `@डॉगफूड-लैब/*` पैकेजों में लॉकस्टेप - वे एक साथ अपडेट होते हैं। इस रीडमी में संस्करण पंक्ति को `पैकेज.जेएसओएन` से `स्क्रिप्ट्स/सिंक-संस्करण.एमजेएस` के माध्यम से स्वचालित रूप से जोड़ा जाता है (यह `प्रीबिल्ड` के रूप में चलता है)। **v1.2.0** तक, छह पैकेज `@डॉगफूड-लैब` दायरे के तहत एनपीएम पर प्रकाशित होते हैं: `स्कीमा`, `सत्यापित करें`, `रिपोर्ट`, `इनजेस्ट`, `फाइंडिंग्स`, `डॉगफूड-स्वार्म`। सातवां (`@डॉगफूड-लैब/पोर्टफोलियो`) मोनोरेपो के भीतर आंतरिक बना रहता है।
