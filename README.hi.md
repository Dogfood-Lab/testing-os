...
<!-- version:start -->
**v1.4.0** — वर्तमान संस्करण। इसमें क्या शामिल किया गया है, यह जानने के लिए [CHANGELOG.md](CHANGELOG.md) देखें।
<!-- version:end -->
...
ऑपरेटर का मार्गदर्शन, कमांड-लाइन इंटरफ़ेस (सीएलआई) संदर्भ, स्कीमा संदर्भ और एकीकरण निर्देश **[हैंडबुक](https://dogfood-lab.github.io/testing-os/handbook/)** में उपलब्ध हैं। प्रत्येक संस्करण के लिए विस्तृत जानकारी [CHANGELOG.md](CHANGELOG.md) में दी गई है।
...
सभी `@dogfood-lab/*` पैकेज एक साथ अपडेट किए जाते हैं — मोनोरपो में सभी पैकेजों का संस्करण संख्या एक ही होती है। छह पैकेज `v1.4.0` पर `@dogfood-lab` के तहत npm पर प्रकाशित होते हैं (`schemas`, `verify`, `report`, `ingest`, `findings`, `dogfood-swarm`); सातवां, `@dogfood-lab/portfolio`, आंतरिक रूप से उपयोग किया जाता है। इस रीडमी (README) के शीर्ष के पास संस्करण पंक्ति को हर बार `npm run build` पर [`scripts/sync-version.mjs`](scripts/sync-version.mjs) के माध्यम से `package.json` से स्वचालित रूप से अपडेट किया जाता है।
