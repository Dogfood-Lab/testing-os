...
<!-- संस्करण: प्रारंभ -->
**v1.9.0** — वर्तमान रिलीज़। इसमें क्या शामिल किया गया है, यह देखने के लिए [CHANGELOG.md](CHANGELOG.md) देखें।
<!-- संस्करण: अंत -->
...
**टेस्टिंग-ओएस क्या छूता है:** प्रत्येक `repository_dispatch` पेलोड में सबमिशन JSON; इस रिपॉजिटरी में `policies/`, `fixtures/`, `records/` और `indexes/`; प्रमाण सत्यापन के लिए `api.github.com` पर आउटबाउंड कॉल; और - केवल `github` सबमिशन के लिए - जमा करने वाले रिपॉजिटरी की `dogfood/scenarios/<scenario_id>.yaml` का रीड-ओनली फ़ेच, जिस पर प्रमाणित कमिट किया गया है (वह परिदृश्य परिभाषा जो आवश्यक-चरण प्रवर्तन को शक्ति प्रदान करती है; उपयोग से पहले आकार-सीमित और स्कीमा-मान्य, अनुपस्थित फाइलें केवल उस जांच को एक दृश्यमान चेतावनी के साथ लागू नहीं होने देती हैं)।
...
सभी `@dogfood-lab/*` पैकेज एक साथ अपडेट किए जाते हैं – मोनोरपो में सभी पैकेजों का संस्करण एक ही नंबर से बदलता है। छह पैकेज `v1.9.0` पर `@dogfood-lab` के तहत npm पर प्रकाशित होते हैं, और ये सभी एक साथ अपडेट होते हैं (`schemas`, `verify`, `report`, `ingest`, `findings`, `dogfood-swarm`); सातवाँ पैकेज, `@dogfood-lab/portfolio`, आंतरिक रूप से ही रहता है। इस रीडमी फ़ाइल के शीर्ष पर संस्करण संख्या स्वचालित रूप से `package.json` से प्राप्त की जाती है, जिसके लिए [`scripts/sync-version.mjs`](scripts/sync-version.mjs) का उपयोग किया जाता है, और यह हर बार `npm run build` कमांड चलाने पर होता है।
