...
<!-- version:start -->
**v1.5.0** — वर्तमान संस्करण। इसमें क्या शामिल किया गया है, यह देखने के लिए [CHANGELOG.md](CHANGELOG.md) देखें।
<!-- version:end -->
...
सभी `@dogfood-lab/*` पैकेज एक साथ अपडेट होते हैं — पूरे मोनोरेपो में एक ही नंबर। छह पैकेज v1.5.0 पर npm पर `@dogfood-lab` के तहत लॉकस्टेप में प्रकाशित होते हैं (`schemas`, `verify`, `report`, `ingest`, `findings`, `dogfood-swarm`); सातवां, `@dogfood-lab/portfolio`, आंतरिक बना रहता है। इस README के शीर्ष के पास संस्करण पंक्ति को प्रत्येक `npm run build` पर [`scripts/sync-version.mjs`](scripts/sync-version.mjs) के माध्यम से `package.json` से स्वचालित रूप से जोड़ा जाता है।
