...
>
> **Scope split:** wave 18 = Tier 1 (declared-link gate on a real AST, C1–C3/C6/C7/C8) + the **full C9 assurance rig** (metamorphic relations, the 7 leaks generalized into relations, a second independently-coded reference matcher diffed in CI, mutation-testing the matcher itself). Wave 19 = Tier 2 (diff-scoped mutation proof, StrykerJS) + the confirming audit. The old heuristic is **retired into the role the literature says it was always valid for**: a candidate-link generator for the migration, granting nothing.
>
