...
**Date:** 2026-05-14 (re-affirmed; first scored 2026-04-25 at v1.0.0)
...
Sourced primarily from [`SHIP_GATE.md`](SHIP_GATE.md): hard gates A–D currently pass at 100% (20 checked / 17 SKIP-with-justification / 0 unchecked); soft gate E is fully met.
...
Honest deltas: every SKIP that remains in SHIP_GATE.md (the MCP / desktop / VSCode items that don't apply, plus the three real follow-ups above) is the reason individual category scores stay below 10. The repo is shippable at v1.1.7 by every applicable contract; the gap is between "shippable" and "perfect."
