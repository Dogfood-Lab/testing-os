...
5. **The grandfathered majority.** At the cutover, most source-pinned ids (256 of ~304, ≈84%) sit in the frozen grandfather manifest rather than under verified declared tags. "The gate is green" therefore means *declared ids verified; frozen debt named and counted* — never *all pins verified*. The bucket is disclosed in the gate's own output (C6), integrity-guarded by content-addressing (F-dbc8b0d1), and drains per the migration strategy above. *(Added wave 22, F-8d789764.)*
